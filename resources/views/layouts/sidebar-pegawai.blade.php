...
{{ request()->routeIs('pegawai.dashboard') ? 'bg-[#0a2f63] text-white font-medium' : 'hover:bg-[#0a2f63]/60 hover:translate-x-[2px] text-blue-100' }}">
...
class="flex items-center px-4 py-3 rounded-xl transition
{{ request()->routeIs('pegawai.profile') ? 'bg-[#0a2f63] text-white font-medium' : 'hover:bg-[#0a2f63]/60 hover:translate-x-[2px] text-blue-100' }}">

<x-heroicon-o-user class="w-5 h-5 mr-3 shrink-0"/>
...
<p class="text-xs text-blue-300 mt-4 leading-relaxed">
Jika lupa password silakan hubungi administrator sistem.
</p>
